...
<body id="page-top">
  ...
  <!-- Page level plugins -->
  <script src="/shop/startbootstrap/vendor/datatables/jquery.dataTables.min.js"></script>
  <script src="/shop/startbootstrap/vendor/datatables/dataTables.bootstrap4.min.js"></script>

  <!-- Page level custom scripts -->
  <script src="/shop/startbootstrap/js/demo/datatables-demo.js"></script>

<%@ include file="/startbootstrap/include/logout.jsp"%>
</body>
</html>