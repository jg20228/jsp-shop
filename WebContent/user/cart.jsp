...
<div class="content__box">
	<div id="cartWrap">
		...
		<div class="page-body">
							...
							<tr class="nbg">
								...
								<td>
									<div class="tb-center">
										<div class="thumb">
											<a
												href="/shop/product?cmd=detail&id=${dto.productId}">
												<img src="${dto.productThumbnail}" alt="상품 섬네일"
												title="상품 섬네일">
											</a>
										</div>
									</div>
								...
								<td>
									<div class="tb-left">
										<a
											href="/shop/product?cmd=detail&id=${dto.productId}"
											style="font-size: 13px; font-weight: bold;">${dto.productName}</a>
								...
								<td>
									<div class="tb-center" style="padding-left: 35px;">
										<div class="opt-spin" style="float: left;">
											<input type="text" name="amount" value="${dto.cartQuantity}"
								...
								<td>
									<div class="tb-center">
										...
										<span class="d-block"><a
											href="javascript:deleteCart(${dto.cartId})"><img
			...
			<div class="mem-lvl">
				<div class="lvl-img">
					<img src="/shopimages/pighip/royalimg_RQ09.gif">
				</div>
				<p>
					저희 쇼핑몰을 이용해주셔서 감사합니다. <span class="user_name">이원재</span>님은 <em>[BLUE]</em>회원이십니다.<br>
					<span class="MS_group_content"> <span class="MS_group_hname">이원재</span>
