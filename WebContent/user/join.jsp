			...
			<table class="person-tb">
				...
				<tbody>
					<tr>
						...
						<td class="none">
							<div class="tb-l pl-6">
								<input type="text" name="name" id="name" value="" class="MS_input_txt w137" size="15" maxlength="30">
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class="tb-l pl-6">
								<input type="text" name="username" id="username" value="" class="MS_input_txt w137" size="10" maxlength="12"> <span> <a style="font-size: 0;" href="javascript:check('id');">
					...
					<tr>
						...
						<td>
							<div class="tb-l pl-6">
								<input type="text" name="post" form="join_form" id="post" class="MS_input_txt" value="" size="3" maxlength="3" onfocus="this.blur();"> <span><a style="font-size: 0;"
					...
					<tr>
						...
						<td>
							<div class="tb-l pl-6">
								<input type="text" name="haddress1" form="join_form" id="haddress1" class="MS_input_txt w415" value="" size="40" maxlength="100" readonly="readonly">
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class="tb-l pl-6">
								<input type="text" name="haddress2" form="join_form" id="haddress2" class="MS_input_txt w415" value="" size="40" maxlength="100">
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class="tb-l pl-6">
								<input type="text" name="hphone1" id="hphone1" value="010" size="10" maxlength="4"> - <input type="text" name="hphone2" id="hphone2" value="" size="10" maxlength="4"> - <input
									type="text" name="hphone3" id="hphone3" value="" size="10" maxlength="4">
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class="tb-l pl-6">
								<input type="text" name="email1" id="email1" onchange="this.form.emailcheck.value=''" class="MS_input_txt" size="10" maxlength="20" value=""> <span>@</span> <span id="direct_email"
									style="margin-top: 3px; display: inline-block"> <input type="text" name="email2" id="email2" class="MS_input_txt" value="" size="15" maxlength="25"
