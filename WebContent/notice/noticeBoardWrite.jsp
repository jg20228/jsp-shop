...
<div class="bbs-table-write">
	<form name="form1" action="board.html" method="post"
		...
		<input type="hidden" name="attach1" value=""> <input
			...
			value="pighip"> <input type="hidden" name="num1" value="">
		<input type="hidden" name="num2" value=""> <input
			type="hidden" name="page" value="1"> <input type="hidden"
			name="ok" value="N"> <input type="hidden" name="board_cate"
			value=""> <input type="hidden" name="b_score[1]" value="">
		<input type="hidden" name="b_score[2]" value=""> <input
			type="hidden" name="b_score[3]" value=""> <input
			type="hidden" name="b_score[4]" value=""> <input
			type="hidden" name="b_score[5]" value=""> <input
			type="hidden" name="branduid" value=""> <input type="hidden"
			name="BRO_CHK_KEY"
			value="39112d75736ad6ee95585e7956a075b0c6052f227d48781c5e98fa15b2233c90">
...
참고 부탁드리며, 항상 최대한 빠른 입고와 배송을 위해 노력하겠습니다 :)</textarea>
					...
					<tr>
						...
						<td>
							<div>
								<input id="bw_input_file" type="text"
									class="MS_input_txt input_style2" name="file_name1" value=""
									onfocus="this.blur();upalert()"> <a
									href="javascript:upload('file_name1');"><img
									src="/design/pighip/img/btn_file.gif"></a>
							</div>
						</td>
					</tr>
				</tbody>
			...
			<tbody>
				<tr>
					<td style="border: 0; text-align: center; padding-left: 120px;">
						<a class="write" href="JavaScript:send();"><img
							src="/design/pighip/img/board_ok.gif" alt="글쓰기"></a> <a
						href="/board/board.html?code=pighip&amp;page=1&amp;board_cate=&amp;s_id=&amp;stext=&amp;ssubject=&amp;scontent=&amp;shname=&amp;sbrand=&amp;sgid=&amp;branduid="><img
							src="/design/pighip/img/board_cancel.gif" alt="글쓰기취소"
							style="margin: 0 0 0 5px;"></a>
					</td>
					<td
						style="border: 0; text-align: right; width: 100px; padding-right: 20px;"><a
						href="/board/board.html?code=pighip&amp;page=1&amp;board_cate=&amp;s_id=&amp;stext=&amp;ssubject=&amp;scontent=&amp;shname=&amp;sbrand=&amp;sgid=&amp;branduid="><img
							src="/design/pighip/img/board_list.gif" alt="목록보기"></a></td>
				</tr>
			</tbody>
		</table>
	</form>
