...
<ul id="noticemenu" class="rollover">
    ...
    <li>
    	<a href="/shop/notice/noticeSize.jsp">
    	    <img src="/shop/image/notice/noticemenu4_over.gif" onmouseover="this.src='/shop/image/notice/noticemenu4_over.gif'" onmouseout="this.src='/shop/image/notice/noticemenu4_over.gif'">
    	</a>
    </li>
    
</ul>

<img src="/shop/testImg/EXsize.png">
